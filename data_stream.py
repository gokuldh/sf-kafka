...
def udf_convert_time(timestamp):
    convert = parse_date(timestamp)
    return str(convert.strftime('%y%m%d%H'))
...
def run_spark_job(spark):
    ...
    converted_df = distinct_table.withColumn("call_datetime", udf_convert_time(distinct_table.call_datetime))
...
if __name__ == "__main__":
    ...
    spark = SparkSession.builder.master("local").appName("Data Streaming SF Crime").getOrCreate()
